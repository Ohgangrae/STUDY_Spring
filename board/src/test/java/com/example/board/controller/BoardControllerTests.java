...
//    }
    ...
    @Test
    public RedirectView modifyTest() throws Exception {
        log.info("modify테스트 : " + mockMvc.perform(MockMvcRequestBuilders.post("/board/modify")
                .param("boardTitle", "success")
                .param("boardContent", "success")
                .param("boardWriter", "success")
        ).andReturn().getModelAndView().getModelMap().toString());
